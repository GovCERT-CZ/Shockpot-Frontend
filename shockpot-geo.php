...
<div class="wrapper">
    <div id="topnav">
        <ul class="nav">
            ...
            <li class="active"><a href="shockpot-geo.php">Shockpot-Geo</a></li>
...
<div class="wrapper">
    <div class="container">
        <div class="whitebox">
            ...
            require_once(DIR_ROOT . '/class/ShockpotGeo.class.php');

            $ShockpotGeo = new ShockpotGeo();

            //-----------------------------------------------------------------------------------------------------------------
            //SHOCKPOT-GEO DATA
            //-----------------------------------------------------------------------------------------------------------------
            $ShockpotGeo->printShockpotGeoData();
            //-----------------------------------------------------------------------------------------------------------------
            //END
            //-----------------------------------------------------------------------------------------------------------------
